...
const plans = [
  {
    ...
    features: [
      ...
      { name: "Portfolio pages", included: true },
      { name: "Before/after galleries", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Lead inbox & CRM", included: true },
      { name: "Quote management", included: true },
      { name: "Follow-ups & site visit scheduling", included: true },
      { name: "WhatsApp integration", included: true },
      { name: "Real-time analytics + lead source", included: true },
      { name: "SEO descriptions", included: true },
      { name: "AI visualization tools", included: false },
      { name: "Conversion tracking", included: false },
    ],
    buttonText: "Get started",
    buttonType: "filled",
    popular: true,
  },
  {
    ...
    features: [
      ...
      { name: "Conversion tracking & analytics", included: true },
      { name: "Case studies & project brochures", included: true },
      { name: "Social media post templates", included: true },
    ],
