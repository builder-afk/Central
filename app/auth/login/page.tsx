  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 relative bg-space-900 items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-electric/10 blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-purple/10 blur-[100px]" />
        ...
        <div className="relative z-10 max-w-md px-12">
          ...
          >
            ...
            <div className="flex items-center gap-3 text-sm text-slate-500">
              ...
              <span>Trusted by 2,400+ architects worldwide</span>
            </div>
          </motion.div>
        </div>
      </div>
